...
function submitWiredContract(event) {
    ...
    let reviewVal = document.getElementById('w_review').value; if (reviewVal === '작성') { if (!validateField('w_review_id', '작성자 ID')) return; visitVal = visitVal + ": " + document.getElementById('w_review_id').value; }
