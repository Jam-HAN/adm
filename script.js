...
function submitWiredContract(event) {
    ...
    let reviewId = document.getElementById('w_review').value; if (reviewId === '작성') { if (!validateField('w_review_id', '작성자 ID')) return; reviewId = "작성자ID: " + document.getElementById('w_review_id').value; }
