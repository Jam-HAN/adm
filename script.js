...
function submitWiredContract(event) {
    ...
    let reviewVal = document.getElementById('w_review').value; if (reviewVal === '작성') { const alertLabel = (reviewVal === '작성') ? '작성자 ID'; if (!validateField('w_review_id', alertLabel)) return; reviewVal = reviewVal + ": " + document.getElementById('w_review_id').value; }
